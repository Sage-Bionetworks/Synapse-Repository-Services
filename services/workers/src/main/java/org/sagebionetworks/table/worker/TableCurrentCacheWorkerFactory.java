...
public class TableCurrentCacheWorkerFactory implements MessageWorkerFactory {
	...
	public Callable<List<Message>> createWorker(List<Message> messages, WorkerProgress workerProgress) {
		return new TableCurrentCacheWorker(messages, tableRowManager, configuration, workerProgress);
	}
}
