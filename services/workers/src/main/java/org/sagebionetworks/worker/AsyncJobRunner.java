...
public interface AsyncJobRunner<RequestType extends AsynchronousRequestBody, ResponseType extends AsynchronousResponseBody> {
	 ...
	 */
	ResponseType run(ProgressCallback progressCallback, String jobId, UserInfo user, RequestType request, AsyncJobProgressCallback jobProgressCallback) throws RecoverableMessageException, Exception;
