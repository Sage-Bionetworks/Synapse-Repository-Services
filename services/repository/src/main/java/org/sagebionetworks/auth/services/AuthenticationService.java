...
public interface AuthenticationService {
	 ...
	 */
	void changePassword(ChangePasswordInterface request) throws NotFoundException;
	 ...
	 */
	PrincipalAlias lookupUserForAuthentication(String alias);
	...
	OAuthUrlResponse getOAuthAuthenticationUrl(OAuthUrlRequest request);
	 ...
	 * @return
	 */
	AuthenticatedOn getAuthenticatedOn(long userId);
	 ...
	 * @return
	 */
	AccessTokenRecordList getPersonalAccessTokenRecords(Long userId, String nextPageToken);
	 ...
	 * @return
	 */
	AccessTokenRecord getPersonalAccessTokenRecord(Long userId, Long tokenId);
	 ...
	 * @param tokenId
	 */
	void revokePersonalAccessToken(Long userId, Long tokenId);
	...
	/**
	 * Revokes the access token in input (e.g. logout)
	 * 
	 * @param token
	 */
	void revokeSessionAccessToken(String token);
	
	/**
	 * Revokes all the access tokens for the given user
	 * @param userId
	 */
