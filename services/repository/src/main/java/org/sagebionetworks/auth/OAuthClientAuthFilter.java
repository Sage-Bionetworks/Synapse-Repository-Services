...
public class OAuthClientAuthFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		modParams.remove(AuthorizationConstants.OAUTH_VALIDATED_CLIENT_ID_PARAM);
		...
		if (up!=null && StringUtils.isNotEmpty(up.getUserName())) {
			try {
				...
				if (oauthClientSecret.equals(up.getPassword())) {
					modParams.put(AuthorizationConstants.OAUTH_VALIDATED_CLIENT_ID_PARAM, new String[] {oauthClientId});
				}
