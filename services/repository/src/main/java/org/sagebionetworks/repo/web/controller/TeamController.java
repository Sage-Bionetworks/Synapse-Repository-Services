...
public class TeamController extends BaseController {
	 ...
	 * 
	 * @param limit the maximum number of Teams to return (default 10, max limit 10)
	 ...
	 * link provided to the user by Synapse via email.
	 * 
	 ...
	 * @param limit the maximum number of members to return (default 10, max limit 10)
	 * @param offset the starting index of the returned results (default 0)
	 * @return
	 * @throws NotFoundException
	 */
