 ...
 * "http://code.google.com/p/maven-gae-plugin/source/browse/trunk/gae-archetype-jsp/src/main/resources/archetype-resources/src/main/java/server/MessageRepository.java?r=738http://code.google.com/p/maven-gae-plugin/source/browse/trunk/gae-archetype-jsp/src/main/resources/archetype-resources/src/main/java/model/Message.java?r=738"
 * >maven-gae-plugin</a> template and modified a tiny bit to serve as an example
 * 
 * @param <T>
 */
public class EntityRepository<T> {
	...
	public T getById(String id) {
		Long numericId = new Long(id); // Our new model classes use String ids
										// but its not worth converting these
										// dummy model classes
		PersistenceManager pm = PMF.get();
		try {
	...
	/**
	 * Return all entities stored in the repository within a particular range
	 * <p>
	 * 
	 * TODO this is a dummy class, therefore I have not bothered to implement
	 * this yet
	 * 
	 * @param offset
	 * @param limit
	...
	/**
	 * Return the count of all entities stored in the repository
	 * <p>
	 * 
	 * TODO this is a dummy class, therefore I have not bothered to implement
	 * this yet
