...
public class EntityController extends BaseController{
	...
	Entity getEntity(
		...
		// Get the entity.
		Entity entity =  serviceProvider.entityService.getEntity(userId, id, request);
		return entity;
	}
	...
	Annotations getEntityAnnotations(
			...
			throws NotFoundException, DatastoreException, UnauthorizedException {
		// Pass it along
		return serviceProvider.entityService.getEntityAnnotations(userId, id, request);
	}
	...
	Annotations updateEntityAnnotations(
		...
		// Pass it along
		return serviceProvider.entityService.updateEntityAnnotations(userId, id, updatedAnnotations, request);
	}
	...
	Entity createEntity(
		...
		Entity createdEntity = serviceProvider.entityService.createEntity(userId, entity, request);
...
//		Entity entity = (Entity) objectTypeSerializer.deserialize(request.getInputStream(), header, type.getClassForType(), header.getContentType());
		...
		// validate the entity
		entity = serviceProvider.entityService.updateEntity(userId, entity, newVersion, request);
		// Return the result
		return entity;
	}
	...
	Entity updateEntity(
		...
		// validate the entity
		entity = serviceProvider.entityService.updateEntity(userId, entity, false, request);
		// Return the result
		return entity;
	}
	...
	public void deleteEntity(
		...
		// Pass it along
		serviceProvider.entityService.deleteEntity(userId, id);
	}
	...
	public void deleteEntityVersion(
		...
		serviceProvider.entityService.deleteEntityVersion(userId, id, versionNumber);
	}
	...
	Entity getEntityForVersion(
		...
		// Get the entity.
		@SuppressWarnings("unchecked")
		Entity updatedEntity = serviceProvider.entityService.getEntityForVersion(userId, id, versionNumber, request);
		// Return the results
	...
	EntityHeader getEntityType(
		...
		return serviceProvider.entityService.getEntityHeader(userId, id);
	}
    ...
    BatchResults<EntityHeader> getEntityTypeBatch(
            ...
            for (String id : ids) {
                    // Get the type of an entity by ID.
                    EntityHeader entityHeader = serviceProvider.entityService.getEntityHeader(userId, id);
	...
	public @ResponseBody UserEntityPermissions getUserEntityPermissions(
		...
		// pass it along.
		return serviceProvider.entityService.getUserEntityPermissions(userId, id);
	}
	/**
	...
	PaginatedResults<EntityHeader> getEntityReferences(
		...
		// Get the type of an entity by ID.
		return serviceProvider.entityService.getEntityReferences(userId, id, null, offset, limit, request);
	}
	...
	PaginatedResults<EntityHeader> getEntityReferences(
			...
			throws NotFoundException, DatastoreException {
		// Get the type of an entity by ID.
		return serviceProvider.entityService.getEntityReferences(userId, id, versionNumber, offset, limit, request);
	}
	...
	EntityPath getEntityPath(
		...
		List<EntityHeader> paths = serviceProvider.entityService.getEntityPath(userId, id);
	...
	AccessControlList createEntityAcl(
		...
		newAcl.setId(id);
		AccessControlList acl = serviceProvider.entityService.createEntityACL(userId, newAcl, request);
		return acl;
	}
	...
	AccessControlList getEntityAcl(
		...
		// pass it along.
		return serviceProvider.entityService.getEntityACL(id, userId, request);
	}
	...
	AccessControlList updateEntityAcl(
		...
		updatedACL.setId(id);
		// pass it along.
		return serviceProvider.entityService.updateEntityACL(userId, updatedACL, request);
	}
	...
	public void deleteEntityACL(
			...
			DatastoreException, UnauthorizedException, ConflictingUpdateException {
		// Determine the object type from the url.
		serviceProvider.entityService.deleteEntityACL(userId, id);
	}
	...
	public @ResponseBody BooleanResult hasAccess(
			...
			HttpServletRequest request) throws DatastoreException, NotFoundException, UnauthorizedException {
		// pass it along.
		return new BooleanResult(serviceProvider.entityService.hasAccess(id, userId, request, accessType));
	}
	...
	EntityHeader getEntityBenefactor(
		...
		// pass it along.
		return serviceProvider.entityService.getEntityBenefactor(id, userId, request);
	}
	...
	PaginatedResults<Versionable> getAllVersionsOfEntity(
		...
		// Determine the object type from the url.
		@SuppressWarnings("unchecked")
		PaginatedResults<Versionable> results = serviceProvider.entityService.getAllVerionsOfEntity(userId, offset, limit, id, request);
		// Return the result
		return results;
	}
	...
	Annotations getEntityAnnotationsForVersion(
			...
			throws NotFoundException, DatastoreException, UnauthorizedException {
		// Pass it along
		return serviceProvider.entityService.getEntityAnnotationsForVersion(userId, id, versionNumber, request);
	}
	...
	S3AttachmentToken createS3AttachmentToken(
		...
		// Pass it along
		return serviceProvider.entityService.createS3AttachmentToken(userId, id, token);
	}
	...
	PresignedUrl getAttachmentUrl(
		...
		// Pass it along.
		return serviceProvider.entityService.getAttachmentUrl(userId, id, url.getTokenID());
	}
}
