...
/**
 * Constants for query parameter keys, header names, and field names 
 * used by the service controllers.<p>
 * 
...
public class ServiceConstants {
    ...
    /**
     * Default value for offset parameter used RequestParam annotations which require a static string 
     */
    public static final String DEFAULT_PAGINATION_OFFSET_PARAM = "1";
    /**
     * Default value for offset parameter
     */
    public static final Integer DEFAULT_PAGINATION_OFFSET = new Integer(DEFAULT_PAGINATION_OFFSET_PARAM);
    ...
    /**
     * Default value for limit parameter used RequestParam annotations which require a static string 
     */
    public static final String DEFAULT_PAGINATION_LIMIT_PARAM = "10";
    /**
     * Default value for limit parameter
     */
    public static final Integer DEFAULT_PAGINATION_LIMIT = new Integer(DEFAULT_PAGINATION_LIMIT_PARAM);
    ...
    /**
     * Request header used to indicate the URL location of a newly created resource
     */
    public static final String LOCATION_HEADER = "Location";
    
    /**
     * Utility method to sanity check pagination parameters<p>
     * 
     * TODO if I can refactor my controllers such that there is only one for CRUD for 
     * all model objects, consider moving this stuff into that file
     * 
     * @param offset
     * @param limit
     * @throws IllegalArgumentException 
     */
    public static void validatePaginationParams(Integer offset, Integer limit) throws IllegalArgumentException {
        if(1 > offset) {
            throw new IllegalArgumentException("pagination offset must be 1 or greater");
        }
        if(1 > limit) {
            throw new IllegalArgumentException("pagination limit must be 1 or greater");
        }
        return;
    }
}
