...
public interface AbstractAnnotatableEntityController<T> {
    ...
    /**
     * Get annotations for a specific entity<p>
     * <ul>
     * <li>TODO response bread crumb urls when we have proper DTOs
     * </ul>
     *   
     * @param id the unique identifier for the entity's annotations to be returned 
    ...
    public @ResponseBody
    abstract Annotations getEntityAnnotations(@PathVariable String id, HttpServletRequest request) throws NotFoundException, DatastoreException;

    /**
     * Update existing annotations for an entity<p>
     * <ul>
     * <li>TODO validate updated entity
     * </ul>
     * 
     * @param id the id of the entity whose annotations we will update 
     * @param etag service-generated value used to detect conflicting updates
     * @param updatedAnnotations the object with which to overwrite the currently stored entity
     * @param request used to get the servlet URL prefix
