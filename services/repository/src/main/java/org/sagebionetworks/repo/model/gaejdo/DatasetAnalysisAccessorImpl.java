...
//	}
	...
	public void delete(Key id) {
		...
		try {
				...
				Collection<GAEJDODatasetAnalysis> analyses = (Collection<GAEJDODatasetAnalysis>)q.execute(id);
				if (analyses.size()!=1) throw new IllegalStateException("Expected 1 but got "+analyses.size());
