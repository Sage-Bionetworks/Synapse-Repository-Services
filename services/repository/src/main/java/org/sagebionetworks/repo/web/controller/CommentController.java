...
public class CommentController extends BaseController implements
	...
	private EntityControllerImp<Comment> entityController = new EntityControllerImp<Comment>(
			Comment.class);
	...
	PaginatedResults<Comment> getEntities(
		...
		return entityController.getEntities(offset, limit, sort, ascending,
				request);
	}
	...
	public @ResponseBody
	Comment getEntity(@PathVariable String id, HttpServletRequest request)
	...
	public @ResponseBody
	Comment createEntity(@RequestBody Comment newEntity,
			HttpServletRequest request) {
	...
	public @ResponseBody
	Comment updateEntity(@PathVariable String id,
			@RequestHeader(ServiceConstants.ETAG_HEADER) Integer etag,
			@RequestBody Comment updatedEntity, HttpServletRequest request)
