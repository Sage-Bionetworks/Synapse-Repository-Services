...
public class TrashController {
	...
	public void moveToTrash(
		...
		this.serviceProvider.getTrashService().moveToTrash(userInfo, id, false);
	}
	...
	public void restoreFromTrash(
			...
			HttpServletRequest request)
			throws NotFoundException, DatastoreException, UnauthorizedException {
		this.serviceProvider.getTrashService().restoreFromTrash(userInfo, id, null);
	}
	...
	public void restoreFromTrash(
			...
			HttpServletRequest request)
			throws NotFoundException, DatastoreException, UnauthorizedException {
		this.serviceProvider.getTrashService().restoreFromTrash(userInfo, id, parentId);
	}
	...
	public @ResponseBody PaginatedResults<TrashedEntity> viewTrashForUser(
		...
		return serviceProvider.getTrashService().viewTrashForUser(userInfo, offset, limit);
	}
	...
	public void flagForPurge(UserInfo userInfo,
			@PathVariable String id,
			HttpServletRequest request)
			throws NotFoundException, DatastoreException, UnauthorizedException {
		this.serviceProvider.getTrashService().flagForPurge(userInfo, id);
	}
