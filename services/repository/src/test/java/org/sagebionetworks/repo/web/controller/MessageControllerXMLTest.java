 ...
 * <p>
 * Dev Note: we are not spending much effort on the XML representation at this
 * time. A deeper test into the structure of the XML will be needed if/when we
 * have anyone consuming xml. The purpose of configuring any XML at all right
 * now is to just confirm that the basic mechanism for varying the response
 * encoding depending upon the Accept header is working.
 * <p>
 * TODO parse the XML to a map using XStream
 * http://xstream.codehaus.org/tutorial.html if we get more serious about
 * supporting XML encoding as a first class citizen
 * <p>
...
public class MessageControllerXMLTest {
	...
	/**
	 * Test method for
	 * {@link org.sagebionetworks.repo.web.controller.MessageController#sanityCheck(org.springframework.ui.ModelMap)}
	 * .
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * Test method for
	 * {@link org.sagebionetworks.repo.web.controller.MessageController#getEntity}
	 * .
	 * 
	 * @throws Exception
	 */
	...
	public void testGetMessageBadId() throws Exception {
		...
		assertTrue(response
				.getContentAsString()
				.startsWith(
						"<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><errorResponse>"));
	}

	/**
	 * Test method for
	 * {@link org.sagebionetworks.repo.web.controller.MessageController#createEntity}
	 * .
	 * 
	 * @throws Exception
	 */
	...
	public void testCreateMessage() throws Exception {
		...
		request.setContent("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><message><text>message from a unit test</text></message>"
				.getBytes("UTF-8"));
		servlet.service(request, response);
		log.info("Results: " + response.getContentAsString());
		...
		assertTrue(response
				.getContentAsString()
				.startsWith(
						"<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><message><id>"));
		assertTrue(response.getContentAsString().endsWith(
				"</id><text>message from a unit test</text></message>"));
	}
	...
	public void testInvalidXMLCreateMessage() throws Exception {
		...
		request.setContent("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><message>message from a unit test</text></message>"
				.getBytes("UTF-8"));
		servlet.service(request, response);
		log.info("Results: " + response.getContentAsString());
		assertEquals(HttpStatus.BAD_REQUEST.value(), response.getStatus());
	...
	/**
	 * Test method for
	 * {@link org.sagebionetworks.repo.web.controller.MessageController#deleteEntity}
	 * .
	 * 
	 * @throws Exception
	 */
	...
	public void testGetMessage() throws Exception {
		...
		// standalone="yes"?><message><id>1</id>
		// <text>message from a unit test</text></message>
		assertTrue(results
				.startsWith("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><message><id>"));
	}

	/**
	 * Test method for
	 * {@link org.sagebionetworks.repo.web.controller.MessageController#getEntities(Integer, Integer, HttpServletRequest)}
	 * .
	 * 
	 * @throws Exception
	 */
	...
	public void testGetMessages() throws Exception {
		...
		// <results xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
		// xsi:type="message"><id>2</id><text>message from a unit
		// test</text></results>
