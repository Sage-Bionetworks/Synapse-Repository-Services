...
public class DefaultControllerAutowiredTest {
	...
	public void testGetSchema() throws Exception{
		...
		toDelete.add(clone.getId());
		// Get the schema
		String schema = ServletTestHelper.getSchema(dispatchServlet, Project.class, clone.getId(), userName);
		assertNotNull(schema);
		// Try without the id
		schema = ServletTestHelper.getSchema(dispatchServlet, Project.class, null, userName);
		assertNotNull(schema);
