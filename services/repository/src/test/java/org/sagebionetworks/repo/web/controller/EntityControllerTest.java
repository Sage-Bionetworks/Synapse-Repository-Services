...
public class EntityControllerTest extends AbstractAutowiredControllerTestBase {
	...
	public void setUp() throws Exception {
		...
		previewTwo.setIsPreview(true);

		List<FileHandle> fileHandleToCreate = new LinkedList<>();
