(function() {
  ...
  window.S3Upload = (function() {
    ...
    var i,x,y,result,ARRcookies=document.cookie.split(";");
    ...
    S3Upload.prototype.executeOnSignedUrl = function(sessionToken, file, callback) {
      var this_s3upload, xhr;
      this_s3upload = this;
      xhr = new XMLHttpRequest();
      xhr.open('GET', this.s3_sign_put_url + '?sessionToken=' + sessionToken, true);
