...
public class AccessApprovalManagerImplAutoWiredTest {
	...
	public void testHappyPath() throws Exception {
		...
		assertFalse(authorizationManager.canAccess(other, entityId, ObjectType.ENTITY, ACCESS_TYPE.DOWNLOAD));
		...
		assertTrue(authorizationManager.canAccess(other, entityId, ObjectType.ENTITY, ACCESS_TYPE.DOWNLOAD));
	}
