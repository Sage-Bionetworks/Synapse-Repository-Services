...
public class StatisticsFileEventUtilsTest {
	...
	public void testBuildFileDownloadEvent() {
		StatisticsFileEvent expectedEvent = new StatisticsFileEvent(FileAction.FILE_DOWNLOAD, 123L, "345",
	...
	public void testBuildFileUploadEvent() {
		StatisticsFileEvent expectedEvent = new StatisticsFileEvent(FileAction.FILE_UPLOAD, 123L, "345",
				"678", FileHandleAssociateType.FileEntity);
