...
public class AccessRequirementUtilTest {
	...
	public void testOwnerEntityRequest() throws Exception {
		...
		List<Long> unmetARs = AccessRequirementUtil.unmetDownloadAccessRequirementIdsForEntity(userInfo, NODE_ID, new ArrayList<Long>(), mockNodeDAO, mockAccessRequirementDAO);
