 ...
 *
 */
public class TabPreviewGenerator extends TabCsvPreviewGenerator implements PreviewGenerator {
	...
	public boolean supportsContentType(String contentType) {
		return contentType.toLowerCase().equals(TEXT_TAB_SEPARATED_VALUES);
	}
	...
	public static void main(String[] args) throws IOException, InterruptedException, InstantiationException, IllegalAccessException{
		for(String filePath: args){
			...
			PreviewGeneratorUtils.calculateMemoryRequirments(toRead, TabPreviewGenerator.class);
		}
	}
