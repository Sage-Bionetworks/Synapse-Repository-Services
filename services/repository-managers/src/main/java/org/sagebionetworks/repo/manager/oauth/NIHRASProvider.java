...
/**
 * OAuthProvider for NIH RAS OpenID Connect server
 * 
 */
public class NIHRASProvider implements OAuthProviderBinding {
	 ...
	 * 
	 * @param apiKey Client ID provided by NIH RAS
	 * @param apiSecret Client Secret provided by NIH RAS
	 */
	public NIHRASProvider(String apiKey, String apiSecret, OIDCConfig oidcConfig) {
		this.apiKey = apiKey;
	...
	public AliasAndType retrieveProvidersId(String authorizationCode, String redirectUrl) {
		throw new IllegalArgumentException("Retrieving alias is not supported in Synapse for the NIH RAS OAuth provider.");
	}
