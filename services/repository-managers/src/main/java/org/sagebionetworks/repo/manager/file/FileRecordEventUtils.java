...
public class FileRecordEventUtils {

    public static FileRecordEvent buildFileEvent(FileEventType fileEventType, Long userId, FileHandleAssociation association) {
    ...
    public static FileRecordEvent buildFileEvent(FileEventType type, Long userId, String fileHandleId,
