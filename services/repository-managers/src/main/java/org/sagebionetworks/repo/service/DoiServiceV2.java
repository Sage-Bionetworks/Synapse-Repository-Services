...
public interface DoiServiceV2 {
	 ...
	 */
	Doi getDoi(String portalId, String objectId, DoiObjectType objectType, Long versionNumber)
	 ...
	 */
	String locate(String portalId, String objectId, DoiObjectType objectType, Long versionNumber)
			throws NotFoundException, UnauthorizedException;
