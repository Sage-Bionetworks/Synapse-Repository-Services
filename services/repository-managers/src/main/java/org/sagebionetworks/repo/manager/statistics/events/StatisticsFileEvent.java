...
public class StatisticsFileEvent implements StatisticsEvent {
	...
	public StatisticsFileEvent(FileAction actionType, Long userId, String fileHandleId, String associationId,
	...
	public FileAction getActionType() {
		return actionType;
	}
