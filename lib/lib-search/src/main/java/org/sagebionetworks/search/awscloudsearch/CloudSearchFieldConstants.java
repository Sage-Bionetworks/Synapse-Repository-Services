...
class CloudSearchFieldConstants {
		...
		static final CloudSearchField CLOUD_SEARCH_FIELD_DIAGNOSIS = new SynapseCreatedCloudSearchField(new IndexField().withIndexFieldName(FIELD_DIAGNOSIS).withIndexFieldType(IndexFieldType.Literal).withLiteralOptions(literalOptionsReturnEnabled));
		...
		static final CloudSearchField CLOUD_SEARCH_FIELD_ORGAN = new SynapseCreatedCloudSearchField(new IndexField().withIndexFieldName(FIELD_ORGAN).withIndexFieldType(IndexFieldType.Literal).withLiteralOptions(literalOptionsReturnEnabled));
