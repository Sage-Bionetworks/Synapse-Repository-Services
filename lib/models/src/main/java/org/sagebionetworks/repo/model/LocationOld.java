 ...
 */
@XmlRootElement
public class LocationOld implements NodeableOld, VersionableOld {
	 ...
	 * @param md5sum 
	 */
	public LocationOld(String type, String path, String md5sum) {
		super();
		this.type = type;
		this.path = path;
		this.md5sum = md5sum;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LocationOld other = (LocationOld) obj;
