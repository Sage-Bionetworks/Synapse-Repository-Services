...
public interface EvaluationDAO {	
	 ...
	 * and optionally filtered by the start and end times derivated from the Evaluation's Quota
	 */
	public List<Evaluation> getAccessibleEvaluationsForProject(String projectId, List<Long> principalIds, ACCESS_TYPE accessType, Long now, long limit, long offset) throws DatastoreException, NotFoundException;
