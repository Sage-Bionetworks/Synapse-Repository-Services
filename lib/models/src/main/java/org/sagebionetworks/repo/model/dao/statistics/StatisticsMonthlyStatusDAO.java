...
public interface StatisticsMonthlyStatusDAO {
	 ...
	 * lastSucceededAt timestamp. Creates a new record if it does not exist.
	 * 
	 * @param  objectType
	 * @param  month
	 * @return
	...
	/**
	 * Sets the status for the given object type and month to {@link StatisticsStatus#PROCESSING}, creates a new record if
	 * it does not exist.
	 * 
	 * @param  objectType
	 * @param  month
