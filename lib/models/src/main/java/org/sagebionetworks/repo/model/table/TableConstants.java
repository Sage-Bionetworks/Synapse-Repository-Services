...
public class TableConstants {
	...
	public static final String SELECT_PROJECTS_BY_SIZE =
			"SELECT "
					+ENTITY_REPLICATION_COL_PROJECT_ID + ", " + ENTITY_REPLICATION_COL_NAME + ", "
					+ " SUM(" + ENTITY_REPLICATION_COL_FILE_SIZE_BYTES + ") AS PROJECT_SIZE_BYTES" +
			"WHERE "+ENTITY_REPLICATION_COL_IN_SYNAPSE_STORAGE+" = TRUE";
}
