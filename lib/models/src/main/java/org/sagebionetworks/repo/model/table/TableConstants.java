...
public class TableConstants {
	...
	public final static String ENTITY_REPLICATION_TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "+OBJECT_REPLICATION_TABLE+"("
			...
			+ "PRIMARY KEY("+ OBJECT_REPLICATION_COL_OBJECT_TYPE + ", " +OBJECT_REPLICATION_COL_OBJECT_ID+")"
			+ ", INDEX ("+OBJECT_REPLICATION_COL_VERSION+")"
			+ ", INDEX ("+OBJECT_REPLICATION_COL_CRATED_BY+")"
			+ ", INDEX ("+OBJECT_REPLICATION_COL_CRATED_ON+")"
	...
	public final static String OBJECT_REPLICATION_INSERT = "INSERT INTO "+OBJECT_REPLICATION_TABLE+" ("
			...
			+ OBJECT_REPLICATION_COL_CRATED_BY+","
			+ OBJECT_REPLICATION_COL_CRATED_ON+","
	...
	public static final String ANNOTATION_REPLICATION_TABLE_CREATE = 
			...
			+" CONSTRAINT `OBJECT_TYPE_OBJECT_ID_FK` FOREIGN KEY ("+ANNOTATION_REPLICATION_COL_OBJECT_TYPE + "," + ANNOTATION_REPLICATION_COL_OBJECT_ID+") REFERENCES "
				+ OBJECT_REPLICATION_TABLE + " ("+OBJECT_REPLICATION_COL_OBJECT_TYPE + "," + OBJECT_REPLICATION_COL_OBJECT_ID+") ON DELETE CASCADE "
			+ ")";
