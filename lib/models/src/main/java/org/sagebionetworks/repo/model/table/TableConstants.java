...
public class TableConstants {
	...
	public static final String SELECT_DISTINCT_ANNOTATION_COLUMNS = 
			"SELECT DISTINCT A."+ANNOTATION_REPLICATION_COL_KEY+", A."+ANNOTATION_REPLICATION_COL_TYPE+
			" FROM "+ENTITY_REPLICATION_TABLE+" AS E"
					+ " INNER JOIN "+ANNOTATION_REPLICATION_TABLE+" AS A"
							+ " ON E."+ENTITY_REPLICATION_COL_ID+" = A."+ANNOTATION_REPLICATION_COL_ENTITY_ID
							+" WHERE E."+ENTITY_REPLICATION_COL_PARENT_ID+" IN (:"+PARENT_ID_PARAMETER_NAME+") limit :"+P_LIMIT+" OFFSET :"+P_OFFSET;
}
