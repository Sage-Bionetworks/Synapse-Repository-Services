...
public class TableConstants {
	...
	public static final String ANNOTATION_REPLICATION_COL_DOUBLE_VALUE_META	="DOUBLE_VALUE_META";
	...
	public static final String ANNOTATION_REPLICATION_TABLE_CREATE = 
			...
			+ ANNOTATION_REPLICATION_COL_DOUBLE_VALUE_META+" ENUM('NaN','Infinity','-Infinity') DEFAULT NULL,"
			...
			+ "INDEX ("+ANNOTATION_REPLICATION_COL_STRING_VALUE+"),"
	...
	public static final String ANNOTATION_REPLICATION_INSERT ="INSERT INTO "+ANNOTATION_REPLICATION_TABLE+"("
			...
			+ANNOTATION_REPLICATION_COL_DOUBLE_VALUE_META+","
