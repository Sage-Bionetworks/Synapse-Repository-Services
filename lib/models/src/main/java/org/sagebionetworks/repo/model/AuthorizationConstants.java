...
public class AuthorizationConstants {
	...
	public static final String YOU_HAVE_NOT_YET_AGREED_TO_THE_SYNAPSE_TERMS_OF_USE = "You have not yet agreed to the Synapse Terms of Use.";
	public static final String YOU_LACK_ACCESS_TO_REQUESTED_ENTITY_TEMPLATE = "You lack %s access to the requested entity.";
	public static final String YOU_DO_NOT_HAVE_PERMISSION_TEMPLATE = "You do not have %s permission for the requested entity, %s.";
	public static final String ONLY_CERTIFIED_USERS_MAY_CHANGE_NODE_SETTINGS = "Only certified users may change node settings.";
	public static final String THERE_ARE_UNMET_ACCESS_REQUIREMENTS = "There are unmet access requirements that must be met to read content in the requested container.";
