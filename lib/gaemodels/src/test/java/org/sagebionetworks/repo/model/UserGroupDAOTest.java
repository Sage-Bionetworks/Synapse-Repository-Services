...
public class UserGroupDAOTest {
	...
	public void happyPath() throws Exception {
		...
		UserDAO userDAO = fac.getUserDAO(null);
		...
		// now 'TestUser 1' should have access to 'TestGroup'
		...
		Assert.assertEquals(1, userGroupDAO.whoHasAccess(group2.getId(), "read").size());
		...
		Assert.assertEquals("TestUser 1", userGroupDAO.whoHasAccess(group2.getId(), "read").iterator().next().getName());
		// TODO fix this
		//Assert.assertEquals(2, userGroupDAO.whoHasAccess(group.getId(), "read").size());
