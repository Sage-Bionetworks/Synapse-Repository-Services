 ...
 * @since Validator 1.4
 */
public class UrlValidatorPatched implements Serializable {
     ...
     */
    private static final UrlValidatorPatched DEFAULT_URL_VALIDATOR = new UrlValidatorPatched();

    /**
     * Returns the singleton instance of this class with default schemes and options.
     * @return singleton instance with default schemes and options
     */
    public static UrlValidatorPatched getInstance() {
     ...
     */
    public UrlValidatorPatched(String[] schemes) {
        this(schemes, 0L);
    }
     ...
     */
    public UrlValidatorPatched(long options) {
     ...
     * ALLOW_2_SLASHES + NO_FRAGMENTS enables both of those options.
     */
    public UrlValidatorPatched(String[] schemes, long options) {
     ...
     */
    public UrlValidatorPatched(RegexValidator authorityValidator, long options) {
     ...
     * enables both of those options.
     */
    public UrlValidatorPatched(String[] schemes, RegexValidator authorityValidator, long options) {
