...
SELECT VER_U.*, PRO.ENTITY_NAME, PRO.CREATED_BY, PRO.CREATED_ON, PRO.PROJECT_ID, PRO.PROJECT_NAME
	 FROM VER_U JOIN PRO ON (VER_U.ENTITY_ID = PRO.ENTITY_ID)