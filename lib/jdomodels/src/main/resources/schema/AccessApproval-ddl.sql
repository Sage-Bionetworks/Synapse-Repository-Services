CREATE TABLE IF NOT EXISTS `ACCESS_APPROVAL` (
  ...
  `REQUIREMENT_VERSION` bigint(20) DEFAULT 0,
  `RESEARCH_PROJECT_ID` bigint(20) DEFAULT NULL,
  `ACCESSOR_ID` bigint(20) NOT NULL,
  `SERIALIZED_ENTITY` mediumblob,
  PRIMARY KEY (`REQUIREMENT_ID`, `ACCESSOR_ID`, `REQUIREMENT_VERSION`, `RESEARCH_PROJECT_ID`),
  UNIQUE KEY (`ID`),
