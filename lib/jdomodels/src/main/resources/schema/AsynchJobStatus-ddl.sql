CREATE TABLE IF NOT EXISTS `ASYNCH_JOB_STATUS` (
  ...
  `REQUEST_HASH` VARCHAR(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT (UUID()),
  `CONTEXT` JSON NOT NULL,
  PRIMARY KEY (`JOB_ID`),
  KEY `ASYNCH_J_S_STARTED_BY_FK` (`STARTED_BY`),
  KEY `REQUEST_HASH_STARTED_BY` (`REQUEST_HASH`, `STARTED_BY`),
