CREATE TABLE IF NOT EXISTS `JDONODE` (
  ...
  CONSTRAINT `NODE_BENEFACTOR_FK` FOREIGN KEY (`BENEFACTOR_ID`) REFERENCES `JDONODE` (`ID`) ON DELETE SET NULL,
  CONSTRAINT `NODE_PROJECT_FK` FOREIGN KEY (`PROJECT_ID`) REFERENCES `JDONODE` (`ID`) ON DELETE SET NULL,
