CREATE TABLE IF NOT EXISTS `NODE` (
  ...
  `NODE_TYPE` ENUM('project', 'folder', 'link','file','table','entityview','dockerrepo','submissionview', 'dataset', 'datasetcollection', 'materializedview', 'virtualtable', 'recordset', 'searchindex') NOT NULL,
