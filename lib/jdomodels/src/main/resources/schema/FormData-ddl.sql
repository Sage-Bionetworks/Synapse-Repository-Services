CREATE TABLE IF NOT EXISTS `FORM_DATA` (
  ...
  CONSTRAINT `FORM_CREATOR_FK` FOREIGN KEY (`CREATED_BY`) REFERENCES `USER_GROUP` (`ID`) ON DELETE RESTRICT,
  CONSTRAINT `FORM_REVIEWER_FK` FOREIGN KEY (`REVIEWED_BY`) REFERENCES `USER_GROUP` (`ID`) ON DELETE RESTRICT
)
