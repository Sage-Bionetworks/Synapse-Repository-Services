CREATE TABLE IF NOT EXISTS `SES_NOTIFICATIONS` (
  ...
  `NOTIFICATION_SUBTYPE` VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `NOTIFICATION_REASON` VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
