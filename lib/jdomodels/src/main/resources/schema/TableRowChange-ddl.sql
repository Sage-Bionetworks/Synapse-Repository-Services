CREATE TABLE IF NOT EXISTS `TABLE_ROW_CHANGE` (
  ...
  `COLUMN_IDS`  varchar(1000) CHARACTER SET latin1 COLLATE latin1_bin,
  `CREATED_BY`  bigint(20)  NOT NULL,
  `CREATED_ON`  bigint(20)  NOT NULL,
  `S3_BUCKET`	varchar(256) CHARACTER SET latin1 COLLATE latin1_bin NOT NULL,
  `S3_KEY`		varchar(256) CHARACTER SET latin1 COLLATE latin1_bin,
  `S3_KEY_NEW`	varchar(256) CHARACTER SET latin1 COLLATE latin1_bin,
