CREATE TABLE `V2_WIKI_PAGE` (
	...
	CONSTRAINT `V2_WIKI_CREATED_BY_FK` FOREIGN KEY (`CREATED_BY`) REFERENCES `PRINCIPAL` (`ID`) ON DELETE CASCADE,
	CONSTRAINT `V2_WIKI_MODIFIED_BY_FK` FOREIGN KEY (`MODIFIED_BY`) REFERENCES `PRINCIPAL` (`ID`) ON DELETE CASCADE
)