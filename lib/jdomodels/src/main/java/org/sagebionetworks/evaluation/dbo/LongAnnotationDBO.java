...
import static org.sagebionetworks.repo.model.query.SQLConstants.DDL_FILE_SUBSTATUS_LONGANNO;
...
public class LongAnnotationDBO implements DatabaseObject<LongAnnotationDBO>{
	...
	@Override
	public TableMapping<LongAnnotationDBO> getTableMapping() {
		return new TableMapping<LongAnnotationDBO>(){
			@Override
			public LongAnnotationDBO mapRow(ResultSet rs, int rowNum)	throws SQLException {
				LongAnnotationDBO result = new LongAnnotationDBO();
				...
				result.setValue(rs.getLong(COL_SUBSTATUS_ANNO_VALUE));
			...
			public String getTableName() {
				return TABLE_SUBSTATUS_LONGANNO;
			}

			@Override
			public String getDDLFileName() {
				return DDL_FILE_SUBSTATUS_LONGANNO;
			}
			...
			@Override
			public Class<? extends LongAnnotationDBO> getDBOClass() {
				return LongAnnotationDBO.class;
			}};
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LongAnnotationDBO other = (LongAnnotationDBO) obj;
		if (Id == null) {
			if (other.Id != null)
				return false;
	...
	public String toString() {
		return "SubmissionStatusLongAnnotationDBO [Id=" + Id
