 ...
 *
 */
public class DatabaeMapping <T extends DatabaseObject> {
	 ...
	 * @param fieldColumns
	 */
	public DatabaeMapping(String tableName, String DDLFilename, FieldColumn[] fieldColumns, RowMapper<T> mapper) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DatabaeMapping other = (DatabaeMapping) obj;
