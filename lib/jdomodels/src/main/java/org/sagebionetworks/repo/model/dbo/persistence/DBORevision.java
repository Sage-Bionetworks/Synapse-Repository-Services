...
public class DBORevision implements MigratableDatabaseObject<DBORevision, DBORevision> {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(getOwner(), that.getOwner()) &&
				...
				Objects.equals(getFileHandleId(), that.getFileHandleId()) &&
				Arrays.equals(getColumnModelIds(), that.getColumnModelIds()) &&
				Arrays.equals(getScopeIds(), that.getScopeIds()) &&
				Arrays.equals(getAnnotations(), that.getAnnotations()) &&
				Arrays.equals(getReference(), that.getReference()) &&
	...
	@Override
	public int hashCode() {
		int result = Objects.hash(getOwner(), getRevisionNumber(), getActivityId(), getLabel(), getComment(), getModifiedBy(), getModifiedOn(), getFileHandleId(), entityPropertiesJSON, userAnnotationsJSON);
		result = 31 * result + Arrays.hashCode(getColumnModelIds());
		result = 31 * result + Arrays.hashCode(getScopeIds());
		result = 31 * result + Arrays.hashCode(getAnnotations());
		result = 31 * result + Arrays.hashCode(getReference());
		return result;
	}
