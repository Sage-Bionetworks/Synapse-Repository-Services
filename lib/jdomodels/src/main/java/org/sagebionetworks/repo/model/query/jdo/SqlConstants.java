...
public class SqlConstants {
	...
	public static final String COL_ASYNCH_TABLE_JOB_ID						= "JOB_ID";
	public static final String COL_ASYNCH_TABLE_JOB_TABLE_ID				= "TABLE_ID";
	public static final String COL_ASYNCH_TABLE_JOB_ETAG					= "ETAG";
	public static final String COL_ASYNCH_TABLE_JOB_STATE					= "JOB_STATE";
	public static final String COL_ASYNCH_TABLE_JOB_TYPE					= "JOB_TYPE";
	public static final String COL_ASYNCH_TABLE_JOB_PROGRESS_CURRENT		= "PROGRESS_CURRENT";
	public static final String COL_ASYNCH_TABLE_JOB_PROGRESS_TOTAL			= "PROGRESS_TOTAL";
	public static final String COL_ASYNCH_TABLE_JOB_PROGRESS_MESSAGE		= "PROGRESS_MESSAGE";
	public static final String COL_ASYNCH_TABLE_JOB_ERROR_MESSAGE			= "ERROR_MESSAGE";
	public static final String COL_ASYNCH_TABLE_JOB_ERROR_DETAILS			= "ERROR_DETAILS";
	public static final String COL_ASYNCH_TABLE_JOB_STARTED_ON				= "STARTED_ON";
	public static final String COL_ASYNCH_TABLE_JOB_STARTED_BY				= "STARTED_BY";
	public static final String COL_ASYNCH_TABLE_JOB_CHANGED_ON				= "CHANGED_ON";
	public static final String COL_ASYNCH_TABLE_JOB_UPLOAD_FILE_HANDLE_ID	= "UPLOAD_FILE_HANDLE_ID";
	public static final String COL_ASYNCH_TABLE_JOB_DOWNLOAD_URL			= "DOWNLOAD_URL";
