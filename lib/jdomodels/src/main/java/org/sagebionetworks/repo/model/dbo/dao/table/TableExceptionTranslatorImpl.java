...
public class TableExceptionTranslatorImpl implements TableExceptionTranslator {
	...
	private static Pattern PATTERN_COLUMM_ID = Pattern.compile(SQLUtils.COLUMN_PREFIX+"[0-9]+"+SQLUtils.COLUMN_POSTFIX);
	...
	public RuntimeException translateException(Throwable exception) {
		...
		if(sqlException != null) {
			...
			// did not find a SQLException and need to wrap the the exception in a RuntimeException
	...
	/**
	 * The columnIds in the given input string.
	 * For example: '_C123_' will result in 123L.  
	 * @param input
	 * @param idToColumnMap
	 * @return
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.sagebionetworks.repo.model.dbo.dao.table.TableExceptionTranslator#replaceColumnIdsAndTableNames(java.lang.String)
	 */
	@Override
