...
public class FilesScannerStatusDaoImpl implements FilesScannerStatusDao {
	...
	private static final String SQL_CREATE = "INSERT INTO " + TABLE_FILES_SCANNER_STATUS + " ("
			...
			+ COL_FILES_SCANNER_STATUS_SCANNED_ASSOCIATIONS_COUNT + ", "
			+ COL_FILES_SCANNER_STATUS_RELINKED_FILES_COUNT + ") VALUES (?, NOW(), NOW(), 0, 0, 0, 0)";
	...
	private static final String SQL_INCREASE_JOB_COMPLETED_COUNT = "UPDATE " + TABLE_FILES_SCANNER_STATUS + " SET " 
			...
			+ COL_FILES_SCANNER_STATUS_RELINKED_FILES_COUNT + " = " + COL_FILES_SCANNER_STATUS_RELINKED_FILES_COUNT + " + ?,"
	...
	@Override
	@WriteTransaction
	public DBOFilesScannerStatus increaseJobCompletedCount(long id, int scannedAssociations, int relinkedFilesCount) {
		int updatedCount = jdbcTemplate.update(SQL_INCREASE_JOB_COMPLETED_COUNT, scannedAssociations, relinkedFilesCount, id);
