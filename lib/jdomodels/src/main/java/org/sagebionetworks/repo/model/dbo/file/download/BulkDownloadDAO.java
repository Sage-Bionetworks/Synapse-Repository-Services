...
public interface BulkDownloadDAO {
	...
	/**
	 * Get the user's download list for update. This call is transactional and uses
	 * the blocking SELECT FOR UPDATE' to fetch the download list. All updates to a
	 * user's download list will be blocked until this transaction concludes.
	 * 
	 * @param ownerPrincipalId
	 * @return
	 */
	DownloadList getUsersDownloadListForUpdate(String ownerPrincipalId);
