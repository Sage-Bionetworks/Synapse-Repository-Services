...
public class DBOActivityDAOImplTest {
	...
	public void testUpdateNotFound() throws Exception {
		when(mockIdGenerator.generateNewId(IdType.ACTIVITY)).thenReturn((long)123);
		...
		act.setId(mockIdGenerator.generateNewId(IdType.ACTIVITY).toString());
	...
	public void testGetNotFound() throws Exception {
		...
		activityDao.get(mockIdGenerator.generateNewId(IdType.ACTIVITY).toString());
	}
	...
	public void testLockActivityAndIncrementEtag() throws Exception {
		...
		when(mockIdGenerator.generateNewId(IdType.ACTIVITY)).thenReturn(id);
