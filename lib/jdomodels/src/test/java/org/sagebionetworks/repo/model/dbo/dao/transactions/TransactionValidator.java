...
interface TransactionValidator {
	...
	String mandatoryReadCommitted(Callable<String> callable) throws Exception;
	...
	public String requiresNewReadCommitted(Callable<String> callable) throws Exception;
