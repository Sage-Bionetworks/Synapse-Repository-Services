...
public class LoginLockoutStatusDaoImplTest {
	...
	public void testGetLockoutInfoWithDoesNotExist() {
		...
		LockoutInfo expected = new LockoutInfo().withNumberOfFailedLoginAttempts(0L).withRemainingMillisecondsToNextLoginAttempt(0L);
	...
	public void testIncrementLockoutInfoWithNewTransactionWithMultipleIncrements() throws InterruptedException {
		...
		assertTrue(info.getRemainingMillisecondsToNextLoginAttempt() > (1<<numberOfAttempts-1)-millisecondsSinceLastIncrement);
