CREATE TABLE IF NOT EXISTS OBJECT_REPLICATION (
    ...
    SUBTYPE ENUM('dockerrepo','entityview','file','folder','link','project','submission','submissionview','table','dataset', 'datasetcollection', 'materializedview', 'virtualtable', 'recordset') NOT NULL,
