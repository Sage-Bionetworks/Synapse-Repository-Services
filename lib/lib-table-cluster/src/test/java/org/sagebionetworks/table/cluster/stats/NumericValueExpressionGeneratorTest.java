...
public class NumericValueExpressionGeneratorTest {
	...
	@InjectMocks
	NumericValueExpressionGenerator numericValueExpressionGenerator;
	...
	public void testGenerate() throws ParseException {
		...
		NumericValueExpression element = new NumericValueExpression(new Term(new Factor(null, new NumericPrimary(new ValueExpressionPrimary(new ColumnReference(
		...
		assertEquals(expected, numericValueExpressionGenerator.generate(element, mapper));
	}
}
