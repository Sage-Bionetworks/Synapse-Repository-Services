 ...
 * @since 4.0
 */
public class ParallelizedDefaultTestContext extends AttributeAccessorSupport implements TestContext {
	...
	private ThreadLocal<Object> testInstanceThreadLocal = new ThreadLocal<Object>();

	private Object testInstanceForAfterAll = null;
	 ...
	 */
	ParallelizedDefaultTestContext(Class<?> testClass, ContextCache contextCache) {
	 ...
	 */
	ParallelizedDefaultTestContext(Class<?> testClass, ContextCache contextCache, String defaultContextLoaderClassName) {
	...
	public final Object getTestInstance() {
		return testInstanceThreadLocal.get();
	}
	...
	public void updateState(Object testInstance, Method testMethod, Throwable testException) {
		this.testInstanceThreadLocal.set(testInstance);
	...
	public String toString() {
		...
		.append("testClass", testClass)//
				.append("testInstance", testInstanceThreadLocal.get())//
	...
	public Object getTestInstanceForAfterAll() {
		return testInstanceForAfterAll;
	}

	public void setTestInstanceForAfterAll(Object testInstanceForAfterAll) {
		this.testInstanceForAfterAll = testInstanceForAfterAll;
	}
}
