...
synapseLogin('david.burdick@sagebase.org','dave')
...
myOutputFile <- synStore(File("/tmp/myOutputFile.txt", parentId=projectId), 
                         used=list(list(name="Script.py", 
                                        url="https://raw.github.com/.../Script.py", 
                                        wasExecuted=T), 
                                   list(entity=myAnnotationFile, 
                                        wasExecuted=F),
                                   list(name="GSM349870.CEL", 
                                        url="http://www.ncbi.nlm.nih.gov/geo/download/...", 
                                        wasExecuted=F)),
                         activityName="Manual Annotation of Raw Data", 
