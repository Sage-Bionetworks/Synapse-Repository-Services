	...
	public static void main(String[] args) throws Exception {
		...
		JSONObject dataset = wiki
				.doPost(
						...
						"h3. Create a Dataset", "Note that the request is a POST and the content type of the data we are sending to the service is json");
		...
		wiki.doDelete(dataset.getString("uri"), "h3. Delete a Dataset",
