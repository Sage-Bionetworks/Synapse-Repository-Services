...
public class SageCommonsActivitiesImplTest {
	...
	SageCommonsActivities activities = new SageCommonsActivitiesImpl(
			new MockSageCommonsChildWorkflowDispatcher());
	...
	public void testUrl() throws Exception {
		// TODO put a test spreadsheet somewhere else and perhaps move this to
	...
	public void testUncompressed() throws Exception {
		int numJobs = activities.processSpreadsheetContents(new File(
				"./src/test/resources/tcga.txt"));
		assertEquals(3, numJobs);
	}
	...
	public void testZip() throws Exception {
		int numJobs = activities.processSpreadsheetContents(new File(
				"./src/test/resources/tcga.zip"));
		assertEquals(3, numJobs);
	}

	/**
	 * Test method for
	 * {@link org.sagebionetworks.workflow.SageCommonsActivitiesImpl#runRScript(java.lang.String, java.lang.String)}
	 * .
	 * 
	 * @throws Exception
	 */
	...
	public void testRunRScript() throws Exception {
		...
		try {
			activities.runRScript(
					"./src/main/resources/simpleScriptThatSucceeds.r",
					spreadsheetData);
		} catch (Exception e) {
			if (-1 != e.getMessage().indexOf(
					"The system cannot find the file specified")) {
				// this happens on window when rscript is not in the path, See
				// PLFM-1111
			} else {
				throw e;
			}
	...
	/**
	 * Test method for
	 * {@link org.sagebionetworks.workflow.SageCommonsActivitiesImpl#formulateNotificationMessage(org.sagebionetworks.repo.model.Layer, java.lang.Integer)}
	 * .
	 */
	@Ignore
	@Test
	...
	/**
	 * Test method for
	 * {@link org.sagebionetworks.workflow.SageCommonsActivitiesImpl#notifyFollowers(java.lang.String, java.lang.String, java.lang.String)}
	 * .
	 */
	@Ignore
	@Test
