		...
		function()
{
	...
	myGetAnnotations <- 
			function(entity)
	{
		RJSONIO::fromJSON(.getCache("datasetAnnotationJSON"))
	}
		...
		function()
{
	...
	suppressWarnings(entity <- SynapseEntity(entity = as.list(RJSONIO::fromJSON(.getCache("datasetJSON")))))
