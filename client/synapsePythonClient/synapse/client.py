...
#            self.anonClient = Synapse('http://140.107.149.29:8080/repo/v1', 'https://staging-auth.elasticbeanstalk.com/auth/v1', 30, False)
            self.anonClient = Synapse('http://localhost:8080/services-repository-0.6.2/repo/v1', 'http://localhost:8080/services-authentication-0.6.2/auth/v1', 30, False)
#            self.anonClient = Synapse('http://140.107.149.29:8080/services-repository-0.6.2/repo/v1', 'http://140.107.149.29:8080/services-authentication-0.6.2/auth/v1', 30, False)
...
#            self.assertEqual(self.anonClient.authEndpoint["protocol"], 'https')
            ...
            # Admin connection
            self.adminClient = Synapse('http://localhost:8080/services-repository-0.6.2/repo/v1', 'http://localhost:8080/services-authentication-0.6.2/auth/v1', 30, False)
#            self.adminClient = Synapse('http://140.107.149.29:8080/services-repository-0.6.2/repo/v1', 'http://140.107.149.29:8080/services-authentication-0.6.2/auth/v1', 30, False)
