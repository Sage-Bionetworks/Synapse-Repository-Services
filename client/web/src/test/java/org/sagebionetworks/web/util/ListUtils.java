...
public class ListUtils {
	...
	/**
	 * Creates a sorted copy of the passed datasets list based on the given
	 * column.
	 * 
	 * @param <T>
	 * @param sortColumn
	 ...
	 * @return
	 */
	public static <T> List<T> getSortedCopy(String sortColumn,
			boolean ascending, List<T> original, Class clazz) {
		// First make a copy
	 ...
	 * @return
	 */
	public static List<Map<String, Object>> getFilteredCopy(
			List<WhereCondition> conList, List<Map<String, Object>> original) {
		// First make a copy
		...
		for (int i = 0; i < original.size(); i++) {
			...
			for (int col=0; col< conList.size(); col++) {
				WhereCondition condition = conList.get(col);
