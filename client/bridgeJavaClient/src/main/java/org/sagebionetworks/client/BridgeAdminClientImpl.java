...
/**
 * Java Client API for Bridge Administrative REST APIs
 */
public class BridgeAdminClientImpl extends BridgeClientImpl implements BridgeAdminClient {
    ...
    public BridgeAdminClientImpl() {
		super();
	}
	
    public BridgeAdminClientImpl(HttpClientProvider clientProvider, DataUploader dataUploader) {
