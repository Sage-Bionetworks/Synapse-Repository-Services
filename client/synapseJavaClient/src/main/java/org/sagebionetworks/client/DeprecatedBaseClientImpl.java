 ...
 */
@Deprecated
public class DeprecatedBaseClientImpl implements BaseClient {
	...
	protected DeprecatedBaseClientImpl(String userAgent, SharedClientConnection sharedClientConnection) {
